...
export function initSettings() {
  ...
  assignEnvVar("BITMEX_CREATE_ORDER_QUEUE", process.env.BITMEX_CREATE_ORDER_QUEUE)
  assignEnvVar("BITMEX_ORDER_CREATED_QUEUE", process.env.BITMEX_ORDER_CREATED_QUEUE)
  assignEnvVar("BITMEX_CREATE_ORDER_CMD_KEY", process.env.BITMEX_CREATE_ORDER_CMD_KEY)
